...
robot_asset_path = assets_root_path + "/Isaac/Robots/Clearpath/Jackal/jackal.usd"
...
while simulation_app.is_running():
    ...
    if my_world.is_playing():
        ...
        if i >= 0 and i < 1000:
            # forward
            robot.apply_wheel_actions(my_controller.forward(command=[0.05, 0.]))
        elif i >= 1000 and i < 1300:
            # rotate
            robot.apply_wheel_actions(my_controller.forward(command=[0.0, np.pi / 12]))
