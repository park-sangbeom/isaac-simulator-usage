...
class FrankTask(BaseTask):
    ...
    def main(self):
        ...
        while simulation_app.is_running():
            ...
            # IK 
            actions, succ = self.controller.compute_inverse_kinematics(
                target_position=np.array([0.5, 0., 0.3]),
                target_orientation=target_orientation)
            my_franka.get_articulation_controller().apply_action(actions)
